...
### Changed
- Auto-bumped V8 to 15.3.76.17.

## [v0.38.3] - 2026-09-18

### Changed
- Auto-bumped V8 to 15.3.76.16.

## [v0.38.2] - 2026-09-17

### Changed
- Auto-bumped V8 to 15.3.76.14.
...
- Release tags need to include the patch number.
  ...
  (https://github.com/stumble/v8go/issues/62)
